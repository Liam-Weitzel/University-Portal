function getAllAJAX() {
    ...
    getStudentProgressAJAX();
}

function getStudentProgressAJAX() {
    var xhttp;
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("studentprogress").innerHTML = xhttp.responseText;
        }
    };

    xhttp.open("GET", "php/tutor-page.php?studentprogress=true", true);
    xhttp.send();
}
